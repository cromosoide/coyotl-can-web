  ...
  return (
    <section className="relative overflow-hidden bg-[#2d0057]">
      ...
      <div className="absolute inset-0 opacity-[0.03]" style={{
        backgroundImage: "radial-gradient(circle at 20% 50%, #e5006b 1px, transparent 1px), radial-gradient(circle at 80% 20%, #e5006b 1px, transparent 1px)",
      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-12 pt-28 sm:px-6 sm:pb-20 sm:pt-36 lg:px-8 lg:pb-28 lg:pt-44">
        ...
        <motion.div
          ...
          className="mb-8 inline-flex items-center gap-2 rounded-full border border-[#e5006b]/30 bg-[#e5006b]/10 px-5 py-2.5 text-sm font-semibold text-white/90 backdrop-blur-sm"
        >
          <span className="inline-block h-2 w-2 animate-pulse rounded-full bg-[#e5006b]" />
        ...
        >
          <a
            ...
            className="animate-pulse-soft inline-flex items-center justify-center gap-2 rounded-2xl bg-[#8002f2] px-8 py-4 text-base font-bold text-white shadow-xl shadow-[#8002f2]/30 transition-all hover:bg-[#6a01cc] hover:shadow-2xl active:scale-95 sm:text-lg"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-2xl border-2 border-[#e5006b]/50 px-8 py-4 text-base font-bold text-white transition-all hover:border-[#e5006b] hover:bg-[#e5006b]/10 active:scale-95 sm:text-lg"
          >
