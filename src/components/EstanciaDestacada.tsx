...
export default function EstanciaDestacada() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-1/3 top-1/2 h-40 w-40 rounded-full bg-[#e5006b]/10" />
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <ScrollReveal delay={0.4}>
            <a
              ...
              className="inline-flex items-center gap-3 rounded-2xl bg-white px-9 py-4 text-base font-bold text-[#8002f2] shadow-xl transition-all hover:bg-white/90 hover:shadow-2xl active:scale-95 sm:text-lg"
            >
